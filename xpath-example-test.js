...
const cNode2 = xpath.select(
  "//strong[contains(text(), 'SS节点')]/following-sibling::code",
  newDoc
);
/*
...
const cNode4 = xpath.select(
  "//strong[contains(text(),'SS节点')]/parent::*//*[preceding-sibling::strong[contains(text(),'SS节点')]]//code",
  newDoc
);
...
const cNode5 = xpath.select(
  "//strong[contains(text(),'SS节点')]/parent::*/self::*/code",
  newDoc
);
